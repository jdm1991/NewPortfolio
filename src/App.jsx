          ...
          <div className="about-details-container">
            <div className="about-containers">
              <div className="details-container">
                <img className="icon" src="/experience.png" alt="experience icon" />
                <h3>Experience</h3>
                <p>
                  2+ years <br />
              ...
              <div className="details-container">
                <img className="icon" src="/education.png" alt="education icon" />
                <h3>Education</h3>
                <p>
                  {" "}
        ...
        <div className="experience-details-container">
          <div className="about-containers">
            <div className="details-container colour-container">
              <div className="article-container">
                <img className="project-img" src="/project1.png" alt="project1" />
              </div>
            ...
            <div className="details-container colour-container">
              <div className="article-container">
                <img className="project-img" src="/project2.png" alt="project2" />
              </div>
            ...
            <div className="details-container colour-container">
              <div className="article-container">
                <img className="project-img" src="/project3.png" alt="project3" />
              </div>
